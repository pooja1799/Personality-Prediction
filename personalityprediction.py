...
df = pd.read_csv('C:/Users/Pooja R/Downloads/archive/IPIP-FFM-data-8Nov2018/data-final.csv', delimiter="\t")
# ************** df
columns = df.columns
...
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['one'].keys()), normalized_all_types_scores['one'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['two'].keys()), normalized_all_types_scores['two'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['three'].keys()), normalized_all_types_scores['three'].values(),color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['four'].keys()), normalized_all_types_scores['four'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['five'].keys()), normalized_all_types_scores['five'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['six'].keys()), normalized_all_types_scores['six'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()
...
plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['seven'].keys()), normalized_all_types_scores['seven'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['eight'].keys()), normalized_all_types_scores['eight'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()


plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['nine'].keys()), normalized_all_types_scores['nine'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()
...
plt.figure(figsize=(15,5))
plt.ylim(0, 1)
plt.bar(list(normalized_all_types_scores['ten'].keys()), normalized_all_types_scores['ten'].values(), color=['black', 'red', 'green', 'blue', 'cyan'])
plt.show()
